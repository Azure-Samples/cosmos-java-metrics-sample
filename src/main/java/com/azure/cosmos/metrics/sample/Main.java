package com.azure.cosmos.metrics.sample;
...
import com.azure.cosmos.metrics.sample.common.AccountSettings;
import com.azure.cosmos.metrics.sample.common.Families;
import com.azure.cosmos.metrics.sample.common.Family;
...
public class Main {
    ...
    protected static Logger logger = LoggerFactory.getLogger(Main.class.getSimpleName());
    ...
    private void getStartedDemo() throws Exception {
        ...
        CosmosClientTelemetryConfig telemetryConfig = new CosmosClientTelemetryConfig()
                .metricsOptions(
                        new CosmosMicrometerMetricsOptions().meterRegistry(createConsoleLoggingMeterRegistry()));
        ...
        client = new CosmosClientBuilder()
                ...
                .preferredRegions(Collections.singletonList("South India"))
        ...
        try {
            ...
            double charge = families.flatMap(family -> {
                return container.createItem(family);
                    ...
                    .reduce(0.0,
                            (charge_n, charge_nplus1) -> charge_n + charge_nplus1) // Mono of total charge - there will
                                                                                   // be only one item in this stream
    ...
    private void readItems(Flux<Family> familiesToCreate) {
        ...
        try {
            ...
            familiesToCreate.flatMap(family -> {
                Mono<CosmosItemResponse<Family>> asyncItemResponseMono = container.readItem(family.getId(),
